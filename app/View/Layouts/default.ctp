...
<head>
  ...
  <title>Welcome to OpenShift di Massimiliano</title>
...
<section class='container'>
          <hgroup>
            <h1>Welcome to your CakePHP application on OpenShift, Massimiliano</h1>
          </hgroup>
        ...
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>How to use this example application, Massimiliano</h2>
